				...
				yamlls = {
					settings = {
						...
						yaml = {
							...
							-- Keep LSP formatting off if you're using Conform for YAML formatting
							format = {
								enable = false,
							},

							-- Pull schemas from SchemaStore
							schemaStore = {
								enable = true,
							},

							-- Optional manual schema bindings
							schemas = {
							...
							-- Optional, only if you use custom tags
							customTags = {},
						},
					},
				},
